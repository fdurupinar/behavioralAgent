...
(CONCEPT
  ...
  (COMMENT
   "adjectives meaning '[does not] allow[s] verb-ing' for some verb (see involves-doing-val)")
  (INHERIT
    ONT::PROCESS-VAL))
...
(CONCEPT
  ONT::ASSURANCE
  (INHERIT
    ONT::NON-MEASURE-ORDERED-DOMAIN)
  (OVERLAP
    WN::|trust%1:26:00::|))
...
(CONCEPT
  ONT::BIOLOGICAL
  (INHERIT
    ONT::SCIENCE-DISCIPLINE-PROPERTY-VAL)
  (OVERLAP
...
(CONCEPT
  ONT::COMPLEXITY-VAL
  (COMMENT
   "Like ont::task-complexity-val, but adverbial that does not define roles of formal, cause and action.")
  (INHERIT
    ONT::PROCESS-VAL))
...
(CONCEPT
  ...
  (INHERIT
    ONT::COST-VAL)
  (OVERLAP
    WN::|costly%5:00:01:expensive:00|
...
(CONCEPT
  ONT::INVOLVES-DOING-VAL
  (COMMENT
   "adjectives meaning '[does not] involve[s] verb-ing' for some verb (see allows-doing-val)")
  (INHERIT
    ONT::PROCESS-VAL))
